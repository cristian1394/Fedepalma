...
public class InventariosCorreccionPage extends InventariosCorreccionMap {
	...
	public InventariosCorreccionPage AceitePalma(String PalmaD, File folderPath) throws Exception {

		time(2);
		scrollElementV(folderPath, txtPalmaD, "scroll ");
		time(1);
		clear(txtPalmaD);
		time(1);
	...
	public InventariosCorreccionPage AceitePalmaOPalmiste(String PalmaoPalmiste, String PalmisteD, File folderPath) throws Exception {

		time(1);
		clear(txtPalmaoPalmiste);
		time(1);
		writeText(txtPalmaoPalmiste, PalmaoPalmiste, folderPath, PalmisteD);
		time(1);
		clear(txtPalmaoPalmisteC);
		time(1);
		writeText(txtPalmaoPalmisteC, PalmisteD, folderPath, PalmisteD);
		time(1);
		captureScreen(folderPath, "Capture screen");
	...
	public InventariosCorreccionPage AceitePalmiste(String PalmisteA, String PalmisteC, String PalmisteD, File folderPath) throws Exception {
	...
	public InventariosCorreccionPage GuardarEdicion(String TotalPalma, String resultado, File folderPath) throws Exception {
		...
		clear(txtTotalPlama);
		time(1);
		writeText(txtTotalPlama, TotalPalma, folderPath, resultado);
		time(1);
		captureScreen(folderPath, "Capture screen");
		time(1);
		time(1);
