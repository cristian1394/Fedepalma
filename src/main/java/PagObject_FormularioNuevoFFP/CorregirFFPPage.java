...
public class CorregirFFPPage extends CorregirFFPMap {
	...
	public CorregirFFPPage CorreccionFFP(String PropiosH, String InicialFrutoG, String InicialFrutoH,
			String BajaFrutoG, File folderPath) throws Exception {

		time(2);
		click(btnCorreccion,folderPath, "click xpath");
		time(15);
		clear(txtCultivosH);
		time(1);
		writeText(txtCultivosH, PropiosH, null, BajaFrutoG);
		time(2);
		clear(txtInicialFrutoG);
		time(1);
		writeText(txtInicialFrutoG, InicialFrutoG, null, BajaFrutoG);
		time(1);
		clear(txtInicialFrutoH);
		time(1);
		writeText(txtInicialFrutoH, InicialFrutoH, null, BajaFrutoG);
		time(2);
		clear(txtBajaFrutoG);
		time(1);
		writeText(txtBajaFrutoG, BajaFrutoG, null, BajaFrutoG);
		time(1);
	...
	public CorregirFFPPage ProveedoresAlmendra(String RPalmaIngresada, String DocRPA, String KG, File folderPath) throws Exception {
		...
		time(2);
		scrollElementV(folderPath, btnBorrar, "scroll ");
		time(1);
	...
	public CorregirFFPPage AlmendraRecibida(String DocARPM, String KG, String PalmisteRecibida, File folderPath) throws Exception {
