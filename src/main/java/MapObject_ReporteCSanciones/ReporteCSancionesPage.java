package MapObject_ReporteCSanciones;
...
public class ReporteCSancionesPage extends BasePage {
	...
	By btnEmpieza=By.xpath("/html/body/div[4]/form/div[2]/div/div[2]/ul/li[5]");//a
	...
	By btnTermina=By.xpath("/html/body/div[5]/form/div[2]/div/div[2]/ul/li[6]");//5
	...
	By btnContiene=By.xpath("/html/body/div[6]/form/div[2]/div/div[2]/ul/li[3]");//8
	...
	By btnNoContiene=By.xpath("/html/body/div[7]/form/div[2]/div/div[2]/ul/li[4]");//0
	...
	public ReporteCSancionesPage ScrollAbajo() {
	...
	@Step("Scroll vertibal abajo")
	public ReporteCSancionesPage ScrollAbajo1() {
	...
	public ReporteCSancionesPage ScrollDerecha() {
	...
	@Step("Deslizar Horizontal a la derecha")
	public ReporteCSancionesPage ScrollDerecha1() {
		Utilidades.time(3000);
		JavascriptExecutor js = (JavascriptExecutor) driver;
	...
	@Step("Evidencia")
	public ReporteCSancionesPage Evidencia() {
    ...
    public ReporteCSancionesPage MenuRCCertificado() {
	...
	@Step("Exportar")
    public ReporteCSancionesPage Exportar() {
    ...
    public ReporteCSancionesPage FP(String Declarante)  {
	...
	@Step("Filtro NIT")
    public ReporteCSancionesPage FNIT(String Kg)  {
    ...
    public ReporteCSancionesPage FSCPalma(String Producto)  {
    ...
    public ReporteCSancionesPage FSCPalmiste(String pais)  {
	...
	@Step("Filtro NIT")
    public ReporteCSancionesPage FNIT1(String Kg)  {
	...
	@Step("Paginacion")
    public ReporteCSancionesPage Paginacion()  {
