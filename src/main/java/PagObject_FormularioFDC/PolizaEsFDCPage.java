...
public class PolizaEsFDCPage extends PolizaEsFDCMap {
    ...
    public PolizaEsFDCPage CrearFDC(File folderPath) throws Exception {
	...
	@Step("Crear poliza")
    public PolizaEsFDCPage CrearPoliza(String resultado, File folderPath) throws Exception {
        time(1);
        ByPixelA();
        time(1);
        ...
        time(1);
        writeText(txtPoli, txtPoliza, folderPath, txtPoliza);
        time(2);
