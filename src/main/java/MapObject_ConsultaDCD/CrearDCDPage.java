...
public class CrearDCDPage extends BasePage {
	...
	protected By btnMes=By.xpath("//*[@id=\"idMonth\"]/option[10]");
	...
	protected By btnOk=By.xpath("/html/body/div[5]/div[7]/div/button");
	protected By lblResultadoCrear=By.xpath("//div[5]/p");
