...
public class IncumplimientoEsFDCPage extends BasePage {
    ...
    public IncumplimientoEsFDCPage CrearFDC() throws Exception {
    ...
    public IncumplimientoEsFDCPage GenerarIncumplimiento(String Asocia) throws Exception {
        Utilidades.time(1000);
        Utilidades.ByPixelA();
        Utilidades.time(1000);
        click(btnTDemo);
